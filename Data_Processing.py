...
def write_csv(path, new_data):
    path_log = r"D:\DatasetCarPro\Data_ASM2\log.txt"
...
def combine2file(path1, path2, path_new):
...
if __name__ == '__main__':
    ...
    # Path of files
    path_revenue = r"D:\DatasetCarPro\Data_ASM2\dataset_sale_car_01.csv"
    path_quantity = r"D:\DatasetCarPro\Data_ASM2\dataset_sale_car_02.csv"
    path_new = r"D:\DatasetCarPro\Data_ASM2\dataset_sale_car_03.csv"
    bc = Bcolors()
    ...
    while True:
        ...
        if choice == 1:
            while True:
                ...
                print("+ Choice: "
                      "\n\t\t1. Display: " + bc.OKCYAN + " Dataset Products." + bc.ENDC +
                      "\n\t\t2. Display: " + bc.OKCYAN + " Dataset Users." + bc.ENDC +
        ...
        # Function combine 2 files csv
            ...
            print("\n+ You have chosen: " + bc.OKGREEN + "Display data was merged" + bc.ENDC)
